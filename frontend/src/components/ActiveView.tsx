                    ...
                    {hints.map((hint) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={cn(
                                    "p-4 rounded-2xl border text-sm leading-relaxed shadow-sm overflow-hidden",
                                    hint.type === 'user'
                                    ...
                                    <ReactMarkdown
                                        ...
                                        components={{
                                            code({ node, inline, className, children, ...props }: any) {
                                                return !inline ? (
                                                    <div className="bg-black/10 dark:bg-black/30 rounded-md p-2 my-2 overflow-x-auto text-xs font-mono">
                                                        <code {...props} className={className}>
                                                            {children}
                                                        </code>
                                                    </div>
                                                ) : (
                                                    <code {...props} className="bg-black/10 dark:bg-white/10 px-1 py-0.5 rounded text-xs font-mono">
                                                        {children}
                                                    </code>
                                                );
                                            },
